...
function gdsGui_dev_createMenuObjects()
	...
	gdsGui_button_create("unitTest"--[[ButtonLable]], 
		...
		(devSpritesPath .. "gdsLoveGUI_devUnitTest_pushed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_devUnitTest_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_devUnitTest_deactivated.png")--[[sprite:deactivated]],
		.5--[[x coordinate]],
		.20--[[y coordinate]],
	...
	gdsGui_button_create("screenDevTests"--[[ButtonLable]], 
		thisPageName--[[page]], 
		"pushonoff"--[[buttonType]],
		(devSpritesPath .. "gdsLoveGUI_screenTestMenuButton_pushed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_screenTestMenuButton_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_screenTestMenuButton_deactivated.png")--[[sprite:deactivated]],
		.5--[[x coordinate]],
		.35--[[y coordinate]],
		"CC"--[[anchorPoint -- string= LT,LC,LB,CT,CC,CB,RT,RC,RB]],
		gdsGui_general_smartScaling ("inverse", 0.36, .54, .080, 0.12, 0.22,"width" )--[[width]],
	...
	gdsGui_button_create("resetData"--[[ButtonLable]], 
		thisPageName--[[page]], 
		"pushonoff"--[[buttonType]],
		(devSpritesPath .. "gdsLoveGUI_devEraseDataButton_pushed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_devEraseDataButton_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_devEraseDataButton_deactivated.png")--[[sprite:deactivated]],
		.5--[[x coordinate]],
		.50--[[y coordinate]],
		"CC"--[[anchorPoint -- string= LT,LC,LB,CT,CC,CB,RT,RC,RB]],
		gdsGui_general_smartScaling ("inverse", 0.36, .54, .080, 0.12, 0.22,"width" )--[[width]],
	...
	gdsGui_button_create("aboutAppPage"--[[ButtonLable]], 
		thisPageName--[[page]], 
		"pushonoff"--[[buttonType]],
		(devSpritesPath .. "gdsLoveGUI_devaAboutButton_pressed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_devaAboutButton_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_devaAboutButton_deactivated.png")--[[sprite:deactivated]],
		.5--[[x coordinate]],
		.65--[[y coordinate]],
		"CC"--[[anchorPoint -- string= LT,LC,LB,CT,CC,CB,RT,RC,RB]],
		gdsGui_general_smartScaling ("inverse", 0.36, .54, .080, 0.12, 0.22,"width" )--[[width]],
	...
	gdsGui_button_create("exitDevMenu"--[[ButtonLable]], 
		thisPageName--[[page]], 
		"pushonoff"--[[buttonType]],
		(devSpritesPath .. "gdsLoveGUI_exitDevMenuButton_pushed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_exitDevMenuButton_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_exitDevMenuButton_deactivated.png")--[[sprite:deactivated]],
		.5--[[x coordinate]],
		.80--[[y coordinate]],
		"CC"--[[anchorPoint -- string= LT,LC,LB,CT,CC,CB,RT,RC,RB]],
		gdsGui_general_smartScaling ("inverse", 0.36, .54, .080, 0.12, 0.22,"width" )--[[width]],
...
function gdsGui_dev_createScreenTestObjects ()
	...
	gdsGui_button_create("returnDevMenu"--[[ButtonLable]], 
		thisPageName--[[page]],
		"pushonoff"--[[buttonType]],
		(devSpritesPath .. "gdsLoveGUI_returnPrevPageButton_pushed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_returnPrevPageButton_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_returnPrevPageButton_deactivated.png")--[[sprite:deactivated]],
		.035--[[x coordinate]],
		.043--[[y coordinate]],
	...
	gdsGui_button_create("switchScreenSize"--[[ButtonLable]],
		thisPageName--[[page]],
		"pushonoff"--[[buttonType]],
		(devSpritesPath .. "gdsLoveGUI_switchScreenSizeButton_pushed.png")--[[sprite: pushed]],
		(devSpritesPath .. "gdsLoveGUI_switchScreenSizeButton_released.png")--[[sprite: released]],
		(devSpritesPath .. "gdsLoveGUI_switchScreenSizeButton_deactivated.png")--[[sprite:deactivated]],
		.5--[[x coordinate]],
		.25--[[y coordinate]],
		"CC"--[[anchorPoint -- string= LT,LC,LB,CT,CC,CB,RT,RC,RB]],
		gdsGui_general_smartScaling ("inverse", 0.36, .54, .080, 0.12, 0.22,"width" )--[[width]],
...
function gdsGui_dev_createEraseDataObjects ()
	...
	gdsGui_button_create("yesConfirmation", thisPageName, "pushonoff",
		(devSpritesPath .. "gdsLoveGUI_yesConfirmButton_pushed.png"),
		(devSpritesPath .. "gdsLoveGUI_yesConfirmButton_released.png"),
		(devSpritesPath .. "gdsLoveGUI_yesConfirmButton_deactivated.png"),
	...
	gdsGui_button_create("noConfirmation", thisPageName, "pushonoff",
		(devSpritesPath .. "gdsLoveGUI_noConfirmButton_pushed.png"),
		(devSpritesPath .. "gdsLoveGUI_noConfirmButton_released.png"),
		(devSpritesPath .. "gdsLoveGUI_noConfirmButton_deactivated.png"),
